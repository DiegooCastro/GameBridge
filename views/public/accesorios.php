...
Public_Page::headerTemplate('Accesorios','public');
?>
...
<div id="Seleccion-Catalogo" class="container-fluid margen">
    <div class="row margenProductos">
        <div id="ContenedorBotones" class="col s12 m12 l3 xl3">
            <h5 class="centrar margenBotones">Categorias <b>Accesorios</b></h5>
            <div class="container">
                <div class="row">
                    ...
                    <div class="col s12">
                        ...
                        <div id="BusquedaFiltrada" class="row">
                            ...
                            <form method="post" id="search-form">
                                <input class="hide" type="text" id="txtCategoria" name="txtCategoria" />
                                <!-- Aqui se guarda el nombre de la categoria -->
                                <input class="hide" type="number" id="txtIdCategoria" name="txtIdCategoria" />
                                <!-- Aqui se guarda el id de la categoria -->
                                <input class="hide" type="number" id="txtSeccion" name="txtSeccion" />
                                <!-- Aqui se guarda el id de la seccion a la que pertenecen las categorias -->
                                ...
                                <div class="input-field col s12">
                                    <a onclick="busquedaFiltrada()" class="waves-effect waves-light btn tooltipped"
                                        data-tooltip="Buscar"><i class="material-icons right">find_in_page</i>Aplicar
                                        filtro</a>
                                </div>

                                <div class="col sm6">
                                    <a onclick="cargarDatos()" class="waves-effect waves-light btn"><i
                                            class="material-icons right">loop</i>Cargar datos</a>
                                </div>
                            </form>
                        </div>
                    </div>
...
<div id="save-modal" class="modal">
    <div class="modal-content">
        ...
        <form method="post" id="save-form" enctype="multipart/form-data">
            ...
            <!-- Aqui se guarda el id de la categoria seleccionada -->
            <div class="row">
                <div id="imagen-producto" class="col m12 l5">
                    <div id="imagen" class="row"></div>
                    <!-- Aqui se ingresa la imagen mediante el inner html desde js. -->
                </div>
                <div id="datos-producto" class="col m12 l7">
                    <div class="row">
                        ...
                        <div id="cantidad-producto" class="row">
                            ...
                            <!-- Aqui se imprime el input numerico desde js. -->
                            </div>
...
Public_Page::footerTemplate('accesorios.js');
?>