...
<div class="container pb-5 mb-2">
    ...
    <div class="d-sm-flex justify-content-between align-items-center text-center text-sm-left">
        ...
        <div class="py-2"><span class="d-inline-block align-middle text-sm text-muted font-weight-medium text-uppercase mr-2">Total a pagar:</span><span class="d-inline-block align-middle text-xl font-weight-medium">$<b id="pago"></b></span></div>
    </div>
    <!-- Buttons-->
    <hr class="my-4">
    <div class="row alignRight">
        <p><button type="button" onclick="finishOrder()" class="btn btn-dark cartButtonSize">Finalizar pedido <i class="bi bi-credit-card-fill"></i></button></p>
        <p><a class="btn btn-secondary cartButtonSize" href="index.php" role="button">Seguir comprando <i class="bi bi-basket-fill"></i></a></p>
    </div>
</div>
