...
Dashboard_Page::headerTemplate('Dashboard | Cambio de clave');
?>
        ...
        <div class="row">
            ...
            print'
                <div class="input-field offset-s3 col s6">
                    ...
                    <input id="alias" type="text" name="alias" autocomplete="off" value="'.$_SESSION['usuario']. '" class="validate" required disabled />
                    <label for="alias">Usuario</label>
                </div>
                <div class="input-field offset-s3 col s6">
                    <i class="material-icons prefix ">do_not_disturb</i>
                    <input id="clave" type="password" name="clave" autocomplete="off" value="'.$_SESSION['clave'].'" class="validate" required disabled />
