...
const API_USUARIOS = '../../app/api/public/clients.php?action=';
        ...
        if (request.ok) {
            request.json().then(function (response) {
                ...
                if (response.status) {
                    ...
                    sweetAlert(4, response.message, null);
                } else {
                ...
                request.json().then(function (response) {
                    ...
                    if (response.status) {
                        ...
                        if (accion == 3) {
                            ...
                            sweetAlert(4, 'Has fallado 3 veces el código seras redirigido al login', 'login.php');          
                        } else {
