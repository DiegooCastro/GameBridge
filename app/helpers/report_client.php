...
class Report extends FPDF
{
    ...
    */
    public function startReport($title)
    {
        ...
        if (isset($_SESSION['id_cliente'])) {
            ...
            $this->title = $title;
            $this->email = $_SESSION['correo_cliente'];
            // Se establece el título del documento (true = utf-8).
            $this->SetTitle('GameBridge | Reporte', true);
    ...
    */
    public function Header()
    {
        ...
        $this->Cell(166, 5, utf8_decode('Cliente: ').$this->email, 0, 1, 'C');
        // Se ubica la fecha y hora del servidor.
        $this->Cell(20);
        $this->SetFont('Arial', '', 10);
        $this->Cell(166, 10, utf8_decode('Fecha de generación: ').date('d-m-Y H:i:s'), 0, 1, 'C');
